<?php
    ...
    $xml_trans = array('patterns' => array("'{{skindir}}'"), 'replacements' => array(_SKIN));
    
    $xsl_trans = array(
        'patterns' => array('/{{XAMS Online help}}/', '/{{Last modification}}/'),
        'replacements' => array($tl->get('XAMS Online help'), $tl->get('Last modification'))
        );
