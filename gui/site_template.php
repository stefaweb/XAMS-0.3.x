<?php
    ...
    if (!empty($button)) {
        ...
        $mySite->Assign2Object(['id', 'templatename', 'name',
        ...
        'addressbook_', 'mode', ]);
        for ($i = 0; $i < $mySite->quotaunit; $i++) {
            $mySite->maxquota *= 1024;
        }
        for ($i = 0; $i < $mySite->userquotaunit; $i++) {
            $mySite->maxuserquota *= 1024;
        }
                    ...
                    <table width="350">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="viruscheckin" class="radiobutton" value="true"<?php if (isTrue($mySite->viruscheckin)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('On')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="viruscheckin" class="radiobutton" value="false"<?php if (isFalse($mySite->viruscheckin)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Off')?>
                            </td>
                            <td style="width: 200px;">
                                <input type="radio" name="viruscheckin" class="radiobutton" value=""<?php if (!$mySite->viruscheckin) {
    echo ' checked="checked"';
            ...
            <tr>
                ...
                <td>
                    <table width="350">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="viruscheckout" class="radiobutton" value="true"<?php if (isTrue($mySite->viruscheckout)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('On')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="viruscheckout" class="radiobutton" value="false"<?php if (isFalse($mySite->viruscheckout)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Off')?>
                            </td>
                            <td style="width: 200px;">
                                <input type="radio" name="viruscheckout" class="radiobutton" value=""<?php if (!$mySite->viruscheckout) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Site dependent')?>
                            </td>
                        </tr>
            ...
            <tr>
                ...
                <td>
                    <table width="350">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="spamcheckin" class="radiobutton" value="true"<?php if (isTrue($mySite->spamcheckin)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('On')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="spamcheckin" class="radiobutton" value="false"<?php if (isFalse($mySite->spamcheckin)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Off')?>
                            </td>
                            <td style="width: 200px;">
                                <input type="radio" name="spamcheckin" class="radiobutton" value=""<?php if (!$mySite->spamcheckin) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Site dependent')?>
                            </td>
                        </tr>
            ...
            <tr>
                ...
                <td>
                    <table width="350">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="spamcheckout" class="radiobutton" value="true"<?php if (isTrue($mySite->spamcheckout)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('On')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="spamcheckout" class="radiobutton" value="false"<?php if (isFalse($mySite->spamcheckout)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Off')?>
                            </td>
                            <td style="width: 200px;">
                                <input type="radio" name="spamcheckout" class="radiobutton" value=""<?php if (!$mySite->spamcheckout) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Site dependent')?>
                            </td>
                        </tr>
	...
	<td><?php echo $mySite->show_field_property('spamscore')?><?php echo $mySite->show_field_property('highspamscore')?></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="bounceforward1" value="true" class="checkbox"<?php if (isTrue($mySite->bounceforward1)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('B&F')?>
                </td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="bounceforward2" value="true" class="checkbox"<?php if (isTrue($mySite->bounceforward2)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('B&F')?>
                </td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="bounceforward3" value="true" class="checkbox"<?php if (isTrue($mySite->bounceforward3)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('B&F')?>
                </td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="bounceforward4" value="true" class="checkbox"<?php if (isTrue($mySite->bounceforward4)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('B&F')?>
                </td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="bounceforward5" value="true" class="checkbox"<?php if (isTrue($mySite->bounceforward5)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('B&F')?>
                </td>
                <td>&nbsp;</td>
