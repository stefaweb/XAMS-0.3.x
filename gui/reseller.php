<?php
    ...
    if ($button) {
        ...
        $myReseller->Assign2Object(['name', 'password', 'locked',
        ...
        if ($myReseller->maxquota > 0) {
            for ($i = 0; $i < $myReseller->quotaunit; $i++) {
                $myReseller->maxquota *= 1024;
            }
        }
        if ($myReseller->maxsitequota > 0) {
            for ($i = 0; $i < $myReseller->sitequotaunit; $i++) {
                $myReseller->maxsitequota *= 1024;
            }
        }
        if ($myReseller->maxuserquota > 0) {
            for ($i = 0; $i < $myReseller->userquotaunit; $i++) {
                $myReseller->maxuserquota *= 1024;
            }
        }
    ...
    if ($myReseller->maxsitequota) {
        for ($myReseller->sitequotaunit = 0; $myReseller->sitequotaunit < 3; $myReseller->sitequotaunit++) {
            if ($myReseller->maxsitequota % 1024 == 0) {
                $myReseller->maxsitequota /= 1024;
            } else {
                break;
            }
    ...
    if ($myReseller->maxuserquota) {
        for ($myReseller->userquotaunit = 0; $myReseller->userquotaunit < 3; $myReseller->userquotaunit++) {
            if ($myReseller->maxuserquota % 1024 == 0) {
                $myReseller->maxuserquota /= 1024;
            } else {
                break;
            }
    ...
    $db = new xclass();
    $sites = $db->db->getAll('SELECT id, resellerid, name FROM pm_sites WHERE resellerid = 0 OR resellerid = ?', [$id], DB_FETCHMODE_ASSOC);
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
    ...
    ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxcustomers" class="checkbox" value="-1"<?php if ($myReseller->maxcustomers < 0) {
    echo ' checked="checked"';
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxsites" class="checkbox" value="-1"<?php if ($myReseller->maxsites < 0) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxdomains" class="checkbox" value="-1"<?php if ($myReseller->maxdomains < 0) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxusers" class="checkbox" value="-1"<?php if ($myReseller->maxusers < 0) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="maxaliases" class="checkbox" value="-1"<?php if ($myReseller->maxaliases < 0) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="quotaunit">
                        <option value="0"<?php if ($myReseller->quotaunit == 0) {
    echo ' selected="selected"';
} ?>>KB</option>
                        <option value="1"<?php if ($myReseller->quotaunit == 1) {
    echo ' selected="selected"';
} ?>>MB</option>
                        <option value="2"<?php if ($myReseller->quotaunit == 2) {
    echo ' selected="selected"';
} ?>>GB</option>
                    </select>
                    <input type="checkbox" name="maxquota" class="checkbox" value="-1"<?php if ($myReseller->maxquota < 0) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="sitequotaunit">
                        <option value="0"<?php if ($myReseller->sitequotaunit == 0) {
    echo ' selected="selected"';
} ?>>KB</option>
                        <option value="1"<?php if ($myReseller->sitequotaunit == 1) {
    echo ' selected="selected"';
} ?>>MB</option>
                        <option value="2"<?php if ($myReseller->sitequotaunit == 2) {
    echo ' selected="selected"';
} ?>>GB</option>
                    </select>
                    <input type="checkbox" name="maxsitequota" class="checkbox" value="-1"<?php if ($myReseller->maxsitequota < 0) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="userquotaunit">
                        <option value="0"<?php if ($myReseller->userquotaunit == 0) {
    echo ' selected="selected"';
} ?>>KB</option>
                        <option value="1"<?php if ($myReseller->userquotaunit == 1) {
    echo ' selected="selected"';
} ?>>MB</option>
                        <option value="2"<?php if ($myReseller->userquotaunit == 2) {
    echo ' selected="selected"';
} ?>>GB</option>
                    </select>
                    <input type="checkbox" name="maxuserquota" class="checkbox" value="-1"<?php if ($myReseller->maxuserquota < 0) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table width="200">
                        <tr>
                            <td>
                                <input type="checkbox" name="viruscheckin" value="true" class="checkbox"<?php if (isTrue($myReseller->viruscheckin)) {
    echo 'checked="checked"';
} ?> /> <?php echo $tl->get('Incoming') ?>
                            </td>
                            <td>
                                <input type="checkbox" name="viruscheckout" value="true" class="checkbox"<?php if (isTrue($myReseller->viruscheckout)) {
    echo 'checked="checked"';
            ...
            <tr>
                ...
                <td>
                    <table width="200">
                        <tr>
                            <td>
                                <input type="checkbox" name="spamcheckin" value="true" class="checkbox"<?php if (isTrue($myReseller->spamcheckin)) {
    echo 'checked="checked"';
} ?> /> <?php echo $tl->get('Incoming') ?>
                            </td>
                            <td>
                                <input type="checkbox" name="spamcheckout" value="true" class="checkbox"<?php if (isTrue($myReseller->spamcheckout)) {
    echo 'checked="checked"';
} ?> /> <?php echo $tl->get('Outgoing') ?>
                            </td>
                        </tr>
    ...
    echo $tl->get('No unassigned sites found.');
} else {
    ?>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="locked" class="checkbox" value="true"<?php if (isTrue($myReseller->locked)) {
    echo ' checked="checked"';
} ?> />
                </td>
                <td>&nbsp;</td>
