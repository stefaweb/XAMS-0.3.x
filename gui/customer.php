<?php
    ...
    if ($button) {
        ...
        $myCustomer->Assign2Object(['name', 'password', 'locked',
    ...
    $sites = $db->getAll('SELECT id, name FROM pm_sites WHERE resellerid = ? ORDER BY name', [$resellerid], DB_FETCHMODE_ASSOC);
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
    ...
    ?>
            ...
            <tr>
                ...
                <td>
                    <input class="password" type="txt" name="password" value="" maxlength="100" size="20" class="textfield" />
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="locked" class="checkbox" value="true"<?php if (isTrue($myCustomer->locked)) {
