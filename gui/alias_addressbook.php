<?php
    ...
    if (!empty($button)) {
        ...
        'acl_reseller', 'acl_customer', 'ord', 'position', ]);
    ...
    include 'header.php';
?>
<h1><?php echo $tl->get('Alias Addressbook Administration'); ?></h1>
<?php show_tabs(['Sites'          => 'site_addressbook.php',
                      ...
                      'Customers' => 'customer_addressbook.php', ], 'Aliases', $tl) ?>
<p>&nbsp;</p>
<?php
    if (!count($overview)) {
...
<?php for ($i = 0; $i < count($overview); $i++) {
    ...
    <tr>
        <td class="addressbook">
            ...
            <input type="text" name="<?php echo "name[$i]" ?>" size="20" maxlength="30" value="<?php echo $overview[$i]['name'] ?>" class="textfield" />
        </td>
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
<table width="700" style="padding: 10px;">
    <tr>
        <th style="font-size: 9pt;"><?php echo $tl->get('Fieldname') ?></th>
        <th style="font-size: 9pt;"><?php echo $tl->get('LDAP') ?></th>
        <th style="font-size: 9pt;"><?php echo $tl->get('ACL Reseller') ?></th>
    ...
    <tr>
        <td class="addressbook"><input type="text" name="name" size="20" maxlength="30" class="textfield" /></td>
