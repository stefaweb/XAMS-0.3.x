<?php
    ...
    if ($button) {
        $myAlias->Assign2Object(['id', 'siteid', 'leftpart', 'rightpart',
...
<?php if ($myAlias->formular_errors) {
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
    ...
    ?>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="bounceforward" value="true" class="checkbox"<?php if (isTrue($myAlias->bounceforward)) {
    echo ' checked="checked"';
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="blackhole" value="true" class="checkbox"<?php if (isTrue($myAlias->blackhole)) {
    echo ' checked="checked"';
} ?>/> <?php echo $tl->get('Yes') ?>
                </td>
                <td>&nbsp;</td>
