<?php
    ...
    if ($button) {
        ...
        $myUser->Assign2Object(['siteid', 'name', 'uniquename', 'id', 'password', 'quotaunit', 'quota',
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
    ...
    ?>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="name" value="<?php echo $myUser->name?>" maxlength="100" size="50" class="textfield"<?php if ($mode == 'update') {
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="quotaunit">
                        <option value="0"<?php if ($myUser->quotaunit == 0) {
    echo ' selected="selected"';
}?>>KB</option>
                        <option value="1"<?php if ($myUser->quotaunit == 1) {
    echo ' selected="selected"';
}?>>MB</option>
                        <option value="2"<?php if ($myUser->quotaunit == 2) {
    echo ' selected="selected"';
}?>>GB</option>
                    </select>
            ...
            <tr>
                ...
                <td>
                    <table width="300">
                        <tr>
                            <td>
                                <input type="checkbox" name="addrtype[]" class="checkbox" value="s"<?php if ($myUser->addrtype & _SMTP) {
    echo ' checked="checked"';
} ?> /> SMTP
                            </td>
                            <td>
                                <input type="checkbox" name="addrtype[]" class="checkbox" value="p"<?php if ($myUser->addrtype & _POP) {
    echo ' checked="checked"';
} ?> /> POP3
                            </td>
                            <td>
                                <input type="checkbox" name="addrtype[]" class="checkbox" value="i"<?php if ($myUser->addrtype & _IMAP) {
    echo ' checked="checked"';
} ?> /> IMAP
                            </td>
                            <td>
                                <input type="checkbox" name="addrtype[]" class="checkbox" value="x"<?php if ($myUser->addrtype & _XAMS) {
    echo ' checked="checked"';
} ?> /> XAMS
                            </td>
                        </tr>
                    ...
                    <table width="350">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="viruscheckin" class="radiobutton" value="true"<?php if (isTrue($myUser->viruscheckin)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('On')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="viruscheckin" class="radiobutton" value="false"<?php if (isFalse($myUser->viruscheckin)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Off')?>
                            </td>
                            <td style="width: 200px;">
                                <input type="radio" name="viruscheckin" class="radiobutton" value=""<?php if (!$myUser->viruscheckin) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Site dependent')?>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table width="350">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="viruscheckout" class="radiobutton" value="true"<?php if (isTrue($myUser->viruscheckout)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('On')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="viruscheckout" class="radiobutton" value="false"<?php if (isFalse($myUser->viruscheckout)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Off')?>
                            </td>
                            <td style="width: 200px;">
                                <input type="radio" name="viruscheckout" class="radiobutton" value=""<?php if (!$myUser->viruscheckout) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Site dependent')?>
                            </td>
                        </tr>
            ...
            <tr>
                ...
                <td>
                    <table width="350">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="spamcheckin" class="radiobutton" value="true"<?php if (isTrue($myUser->spamcheckin)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('On')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="spamcheckin" class="radiobutton" value="false"<?php if (isFalse($myUser->spamcheckin)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Off')?>
                            </td>
                            <td style="width: 200px;">
                                <input type="radio" name="spamcheckin" class="radiobutton" value=""<?php if (!$myUser->spamcheckin) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Site dependent')?>
                            </td>
                        </tr>
            ...
            <tr>
                ...
                <td>
                    <table width="350">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="spamcheckout" class="radiobutton" value="true"<?php if (isTrue($myUser->spamcheckout)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('On')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="spamcheckout" class="radiobutton" value="false"<?php if (isFalse($myUser->spamcheckout)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Off')?>
                            </td>
                            <td style="width: 200px;">
                                <input type="radio" name="spamcheckout" class="radiobutton" value=""<?php if (!$myUser->spamcheckout) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Site dependent')?>
                            </td>
                        </tr>
...
<th><?php echo $tl->get('Spam Score Trigger')?></th>
	...
	<td><?php echo $myUser->show_field_property('spamscore')?><?php echo $myUser->show_field_property('highspamscore')?></td>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="relayonauth" class="checkbox" value="true"<?php if (isTrue($myUser->relayonauth)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Yes')?>
                </td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="relayoncheck" class="checkbox" value="true"<?php if (isTrue($myUser->relayoncheck)) {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Yes')?>
                </td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <table width="410">
                        <tr>
                            <td style="width: 100px;">
                                <input type="radio" name="accountstate" class="radiobutton" value="default"<?php if ($myUser->accountstate == 'default') {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Active')?>
                            </td>
                            <td style="width: 100px;">
                                <input type="radio" name="accountstate" class="radiobutton" value="locked"<?php if ($myUser->accountstate == 'locked') {
    echo ' checked="checked"';
} ?> /> <?php echo $tl->get('Locked')?>
                            </td>
                            <td style="width: 210px;">
                                <input type="radio" name="accountstate" class="radiobutton" value="lockedbounce"<?php if ($myUser->accountstate == 'lockedbounce') {
    echo ' checked="checked"';
