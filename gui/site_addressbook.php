...
<?php for ($i=0; $i<count($overview); $i++) { ?> 
    <tr>
        ...
        <td class="addressbook">
            <select name="<?php echo "position[$i]" ?>" style="width: 90px;"><option /><?php for ($i2=0; $i2<count($overview); $i2++) echo '<option value="'. $overview[$i2]['ord']. '">'. $overview[$i2]['name']. '</option>' ?></select>
        </td>
