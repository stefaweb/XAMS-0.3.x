<?php
    ...
    include 'header.php';
?>
<h1><?php echo $tl->get('Site Addressbook Administration'); ?></h1>
<?php show_tabs(['Sites'          => 'site_addressbook.php',
                      ...
                      'Customers' => 'customer_addressbook.php', ], 'Sites', $tl) ?>
<p>&nbsp;</p>
<?php
    if (!count($overview)) {
...
<?php for ($i = 0; $i < count($overview); $i++) {
    ...
    <tr>
        ...
        <td class="addressbook">
            <select name="<?php echo "position[$i]" ?>" style="width: 90px;"><option /><?php for ($i2 = 0; $i2 < count($overview); $i2++) {
